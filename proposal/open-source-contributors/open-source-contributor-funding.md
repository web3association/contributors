...
[Contributor Funding](https://app.gitbook.com/o/jOQu4b6VLDxaQsg2rVwG/s/MknWvDkc5shALcb0cpEH/)
{% endcontent-ref %}
...
For **contributors,** this funding process represents a more simple and quick approach for them to join an ecosystem and be considered as a candidate to receive funding. Contributors would have more flexibility to generate impact in the ecosystem in a multitude of ways based on their own preferences and skill sets. Contributors would not be tied to a single idea which would mean they can become increasingly more autonomous over time in deciding what they work on. All that matters for a contributor is that they generate as much impact as possible for the ecosystem. Contributors would benefit from increased income stability due to their compensation being directly paid to them from the treasury. Contributors would have more ownership and influence over their own career trajectory and building up their reputation.

For **voters,** this suggested contributor funding process could offer a far simpler and easier decision making process that is more suitable for a larger audience of participating community members. Voting can gets easier over time as community members learn which contributors are the most performant and then reselect them in future voting rounds.

For **Web3 ecosystem**s, treasuries could become more effective at generating impact if assets are used more efficiently. Funds would pay for contributors directly and would sit idle in over funded ideas. Contributor funding can provide a reliable long term approach for developing open source initiatives that help to improve an ecosystems network, infrastructure, protocols, software libraries and applications. As the contributor funding process matures there is even an opportunity that it could create one of the safest and most reliable ways for founding entities to push the stewardship of an ecosystem over to the community.
